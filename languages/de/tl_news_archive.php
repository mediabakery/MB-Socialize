 ...
 * Legends
 */
$GLOBALS['TL_LANG']['tl_news_archive']['mb_socialize_legend'] = 'MB Socialize Einstellungen';

/**
 * Fields
 */
$GLOBALS['TL_LANG']['tl_news_archive']['socialNews'] = array('MB Socialize aktivieren','MB Socialize aktivieren.');
$GLOBALS['TL_LANG']['tl_news_archive']['socialNewsService'] = array('Service','MB Socialize Service wählen.');
